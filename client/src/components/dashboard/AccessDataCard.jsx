      ...
      <div className="card-body">
          ...
          <div className="alert alert-warning mb-4">
            ...
            <div>
              ...
              <div className="text-xs">
                Запустите access.exe для получения реальных данных от майнеров.
              </div>
            </div>
          </div>
        )}
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="card-title text-lg text-primary">
            ...
            {hasRealData && (
              <span className="badge badge-success badge-sm ml-2">Реальные данные</span>
            )}
            {hasTestData && !hasRealData && (
              <span className="badge badge-warning badge-sm ml-2">Только тестовые</span>
            )}
          </h2>
        ...
        {!showMinersTable && showHex && accessHexData && (
          <div className="bg-base-300 rounded-lg p-4 overflow-auto max-h-96">
            <pre className="text-xs text-primary whitespace-pre font-mono">{accessHexData}</pre>
          </div>
        )}
      </div>
    </div>
